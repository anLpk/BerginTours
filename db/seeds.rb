...
file_4 = File.open(File.join(Rails.root,'app/assets/images/Cappadocia/2_days_cappadocia_tour_from_istanbul/two_days_1.jpg'))
...
tour_1.photos.attach(io: file_4, filename: 'two_days_1.jpg', content_type: 'image/jpg')
